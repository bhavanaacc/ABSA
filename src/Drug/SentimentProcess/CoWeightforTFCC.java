...
public class CoWeightforTFCC {
    ...
    public static void Birth_ControlWeight() {
        ...
        try {
            ...
            ResultSet rs = (ResultSet) st.executeQuery("select * from cooccurance where aspect='Birth Control'");
    ...
    public static void Depressionweight() {
          ...
          try {
            ...
            ResultSet rs = (ResultSet) st.executeQuery("select * from cooccurance where aspect='Depression'");
    ...
    public static void Painweight() {
     ...
     try {
            ...
            ResultSet rs = (ResultSet) st.executeQuery("select * from cooccurance where aspect='Pain'");
    ...
    public static void Bipolar_Disordeweight() {
     ...
     try {
            ...
            ResultSet rs = (ResultSet) st.executeQuery("select * from cooccurance where aspect='Bipolar Disorde'");
    ...
    public static void Weight_Lossweight() {
       try {
            ...
            ResultSet rs = (ResultSet) st.executeQuery("select * from cooccurance where aspect='Weight Loss'");
