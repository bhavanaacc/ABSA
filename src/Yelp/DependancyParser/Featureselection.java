        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (aspect.equalsIgnoreCase("food")) {
                    foodF.add(id + "#" + dependancy);
                }
                if (aspect.equalsIgnoreCase("ambience")) {
                    ambianceF.add(id + "#" + dependancy);
                }
                if (aspect.equalsIgnoreCase("service")) {
                    serviceF.add(id + "#" + dependancy);
                }
                if (aspect.equalsIgnoreCase("price")) {
                    priceF.add(id + "#" + dependancy);
                }
                if (aspect.equalsIgnoreCase("Worthiness")) {
                    worthinessF.add(id + "#" + dependancy);
                } 
                if (aspect.equalsIgnoreCase("Restaurant")) {
                    restaurantF.add(id + "#" + dependancy);
                } 
            }
    ...
    public static void GneerateTrainMatrix() {
        try {
            ...
            while (rs.next()) {
                ...
                String worth = Double.valueOf(rs.getString(6)) > 0.0 ? "1" : "0";
                ...
                System.out.println(aspect + "\t" + term + "\t" + ambiance + "\t" + food + "\t" + worth + "\t" + rest + "\t" + service + "\t" + price);
                String query = "insert into dptrainmatrix (aspect, term,ambiance,food,worthiness,restaurant,service,price) values ('" + aspect + "','" + term + "','" + ambiance + "','" + food + "','" + worth + "','" + rest + "','" + service + "','"+price+"')";
