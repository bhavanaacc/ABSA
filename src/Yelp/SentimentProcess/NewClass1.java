...
//        Connection con=(Connection) db.conn();
            ...
            while (rs.next()) {
                double a = Double.valueOf(rs.getString(4)); //amb
                double b = Double.valueOf(rs.getString(5));//food
                double c = Double.valueOf(rs.getString(6));//worth
                double d = Double.valueOf(rs.getString(7));//res
                double e = Double.valueOf(rs.getString(8));//ser
                double f = Double.valueOf(rs.getString(9));//price
                som = a + b + c + d + e + f;
                sum = a + "," + b + "," + c + "," + d + "," + e + "," + f + "," + som;
