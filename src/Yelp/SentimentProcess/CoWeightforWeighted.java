       ...
       public static void Worthiness()
    {
     try{
        ...
        Connection con=(Connection) db.conn();
           ...
           AspectListWorth =GetList("Worthiness");
            ResultSet rs = (ResultSet) st.executeQuery("select * from weighted where aspect='Worthiness'");
            ...
            while (rs.next()) {
                ...
                for(int start=0; start<AspectListWorth.size(); start++)
                {
                  String[] dataparts = AspectListWorth.get(start).toString().split(",");
                  String Fs =dataparts[2].toString();
                ...
                double avg= (sum /Double.valueOf(AspectListWorth.size()));
                if (Double.isNaN(avg)|| Double.isInfinite(avg))  { avg=(float) 0.0;}
                System.out.println("Term \t"+term +"Average \t"+avg);
                st1.executeUpdate("update weighted set weight='"+String.valueOf(avg)+"' where id ="+id+"");
                AspectListWorth.remove(term);
       }
}
         ...
         public static void Restaurant()
    {
     try{
        ...
        Connection con=(Connection) db.conn();
           ...
           AspectListResto =GetList("Restaurant");
            ResultSet rs = (ResultSet) st.executeQuery("select * from weighted where aspect='Restaurant'");
            ...
            while (rs.next()) {
                ...
                for(int start=0; start<AspectListResto.size(); start++)
                {
                  String[] dataparts = AspectListResto.get(start).toString().split(",");
                  String Fs =dataparts[2].toString();
                ...
                double avg= (sum /Double.valueOf(AspectListResto.size()));
                if (Double.isNaN(avg)|| Double.isInfinite(avg))  { avg=(float) 0.0;}
                System.out.println("Term \t"+term +"Average \t"+avg);
                st1.executeUpdate("update weighted set weight='"+String.valueOf(avg)+"' where id ="+id+"");
                AspectListResto.remove(term);
       }
}
catch(Exception ex){ System.out.println("5"+ex);}
    }
