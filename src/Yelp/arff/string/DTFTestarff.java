...
public class DTFTestarff {
    ...
    public static void main(String[] str) {
        ...
        File file = new File("F:/arff2/DTFTestarff.arff");
        ...
        try {
            ...
            writer.write("\n");
            writer.write("@attribute 'aspect' {Ambience,Price,Service,Restaurant,Worthiness,Food,ambience,price,service,restaurant,worthiness,food}");
            writer.write("\n");
            writer.write("@data");
            writer.write("\n");
            while (rs.next()) {
